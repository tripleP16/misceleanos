...
int _pokemonEstimateSize(
  ...
  bytesCount += 3 + object.sprinteFront.length * 3;
  return bytesCount;
}
...
void _pokemonSerialize(
  ...
  writer.writeString(offsets[2], object.sprinteFront);
}
...
Pokemon _pokemonDeserialize(
  ...
  final object = Pokemon(
    ...
    sprinteFront: reader.readString(offsets[2]),
  );
  return object;
}
...
extension PokemonQueryFilter
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sprinteFront',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterFilterCondition> sprinteFrontIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'sprinteFront',
        value: '',
...
extension PokemonQuerySortBy on QueryBuilder<Pokemon, Pokemon, QSortBy> {
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortBySprinteFront() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sprinteFront', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> sortBySprinteFrontDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sprinteFront', Sort.desc);
    });
  }
}
...
extension PokemonQuerySortThenBy
  ...
  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenBySprinteFront() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sprinteFront', Sort.asc);
    });
  }

  QueryBuilder<Pokemon, Pokemon, QAfterSortBy> thenBySprinteFrontDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'sprinteFront', Sort.desc);
    });
  }
...
extension PokemonQueryWhereDistinct
  ...
  QueryBuilder<Pokemon, Pokemon, QDistinct> distinctBySprinteFront(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'sprinteFront', caseSensitive: caseSensitive);
    });
  }
}
...
extension PokemonQueryProperty
  ...
  QueryBuilder<Pokemon, String, QQueryOperations> sprinteFrontProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'sprinteFront');
    });
  }
}
